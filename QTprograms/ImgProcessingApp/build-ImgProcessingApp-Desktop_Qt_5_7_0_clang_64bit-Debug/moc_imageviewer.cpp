...
#include "../ImgProcessingApp/imageviewer.h"
...
QT_MOC_LITERAL(1, 12, 13), // "Image_updated"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 9), // "set_image"
QT_MOC_LITERAL(4, 37, 3) // "img"

    },
    "ImageViewer\0Image_updated\0\0set_image\0"
    "img"
};
...
void ImageViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Image_updated(); break;
        case 1: _t->set_image((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageViewer::Image_updated)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ImageViewer::Image_updated()
{
